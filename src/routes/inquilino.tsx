    ...
    return (
      <main className="mx-auto max-w-6xl px-4 py-8">
        <header className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">Visão de administrador — todos os inquilinos cadastrados.</p>
        </header>
        <AdminUsersPanel role="tenant" />
      </main>
    );
  }

  return <Dashboard role="tenant" />;
}
